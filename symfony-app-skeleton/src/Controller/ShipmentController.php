...
class ShipmentController extends BaseController
{
    ...
    public function __construct(SerializerInterface $serializer, AutoMapping $autoMapping, ValidatorInterface $validator, ShipmentService $shipmentService)
    {
    ...
    public function createShipmentOrder(Request $request)
    {
        ...
        $result = $this->shipmentService->createShipmentOrder($request);
    ...
    {
        $result = $this->shipmentService->getShipmentsOrdersByStatus($status);
    ...
    public function updateShipmentOrderStatus(Request $request)
    {
        ...
        $result = $this->shipmentService->updateShipmentOrderStatus($request);
