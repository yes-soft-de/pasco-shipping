...
import 'package:pasco_shipping/module_unit/state_manger/units_state_manager.dart';
import 'package:pasco_shipping/module_unit/ui/state/units_state/units_state.dart';
import 'package:pasco_shipping/module_unit/ui/state/units_state/units_successfully.dart';
import 'package:pasco_shipping/utils/widget/background.dart';
import 'package:pasco_shipping/utils/widget/loding_indecator.dart';

@injectable
class UnitsScreen extends StatefulWidget {
  final UnitStateManager _stateManager;

  UnitsScreen(this._stateManager);

  @override
  _CountriesScreenState createState() => _CountriesScreenState();
}

class _CountriesScreenState extends State<UnitsScreen> {
  late UnitsState currentState;
  late List<UnitModel> items;
  @override
  ...
  Widget Screen(){
    if(currentState is LoadingState){
      ...
      return UnitsSuccessfully(items: items ,onDelete: (id){
        widget._stateManager.deleteUnit(id.toString());
      },
        onEdit: (request){
          widget._stateManager.updateUnit(request);
        },
      );
    }
