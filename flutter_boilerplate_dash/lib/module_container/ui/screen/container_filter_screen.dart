...
import 'package:pasco_shipping/module_container/state_manger/filter_container_state_manger.dart';
import 'package:pasco_shipping/module_container/ui/state/filter_container_state/filter_container_init.dart';
...
@injectable
class ContainerFilterScreen extends StatefulWidget {
  final FilterContainerStateManager _stateManager;

  const ContainerFilterScreen(this._stateManager);
