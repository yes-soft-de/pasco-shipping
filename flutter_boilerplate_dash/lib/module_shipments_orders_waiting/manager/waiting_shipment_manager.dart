...
class WaitingShipmentManager{
  ...
  Future<List<WaitingShipmentModel>?> getWaitingShipment(WaitingShipmentFilterRequest transportationType) => _repository.getWaitingShipmentFilter(transportationType);
