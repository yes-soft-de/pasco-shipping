...
class SelectShiftingWarehousesSuccessfully extends StatefulWidget {
  final List<WarehousesModel> items;
  final Function goToShiftShipment;


  const SelectShiftingWarehousesSuccessfully({required  this.items,required this.goToShiftShipment,});

  @override
  _SelectWarehousesSuccessfullyState createState() => _SelectWarehousesSuccessfullyState();
}

class _SelectWarehousesSuccessfullyState extends State<SelectShiftingWarehousesSuccessfully> {
