...
class AddDistributorInit extends StatefulWidget {
  final Function onSave;
  const AddDistributorInit({ required this.onSave});

  @override
  _AddCountryInitState createState() => _AddCountryInitState();
}

class _AddCountryInitState extends State<AddDistributorInit> {
        ...
        child: Card(
          ...
          child: Padding(
            ...
            child: Column(children: [
              Image.asset(StaticImage.distrbutors),
              Padding(
              ...
              RoundedButton(lable: S.of(context).save, icon: '', color: AppThemeDataService.AccentColor, style: AppTextStyle.largeWhiteBold, go: (){
                if(name.text.isEmpty || phone.text.isEmpty || address.text.isEmpty) {
                  ...
                  DistributorRequest re = DistributorRequest(address: address.text ,fullName: name.text ,phone: phone.text);
                  widget.onSave(re);
                }
              }, radius: 15)
            ],),
