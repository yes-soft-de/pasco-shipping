...
import 'package:pasco_shipping/module_airwaybill/state_manger/filter_airwaybill_state_manger.dart';
import 'package:pasco_shipping/module_airwaybill/ui/state/filter_container_state/filter_airwaybill_init.dart';
...
@injectable
class AirwaybillFilterScreen extends StatefulWidget {
  final FilterAirwaybillStateManager _stateManager;

  const AirwaybillFilterScreen(this._stateManager);

  @override
  _AddNewCountryState createState() => _AddNewCountryState();
}

class _AddNewCountryState extends State<AirwaybillFilterScreen> {
  late FilterAirwaybillState currentState;
  ...
  void initState() {
    ...
    widget._stateManager.getSubContract();
  }
