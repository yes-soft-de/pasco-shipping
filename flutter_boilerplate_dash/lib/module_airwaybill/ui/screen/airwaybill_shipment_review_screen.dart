...
@injectable
class AirwaybillShipmentReview extends StatefulWidget {
  // final ShipmentModel shipment;
  AirwaybillShipmentReview();

  @override
  _ContainerShipmentReviewState createState() => _ContainerShipmentReviewState();
}

class _ContainerShipmentReviewState extends State<AirwaybillShipmentReview> {
