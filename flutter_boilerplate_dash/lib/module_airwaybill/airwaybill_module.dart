...
import 'ui/screen/airwaybill_update_screen.dart';
...
class AirwaybillModule extends YesModule {
  ...
  final UpdateAirwaybill _updateAirwaybill;

  AirwaybillModule(this._screen, this._addNewContainer, this._filterScreen, this._detailsScreen, this._containerShipmentReview, this._financeScreen, this._updateAirwaybill) {
  ...
  Map<String, WidgetBuilder> getRoutes() {
    return {
      ...
      AirwaybillRoutes.UPDATE: (context) => _updateAirwaybill,
