...
class UpdateEmployeeRoleInit extends StatefulWidget {
  final Function onSave;
  final EmployeeModel model;
  const UpdateEmployeeRoleInit({ required this.onSave,required this.model});

  @override
  _AddCountryInitState createState() => _AddCountryInitState();
}

class _AddCountryInitState extends State<UpdateEmployeeRoleInit> {
...
//  late  TextEditingController phone;
 ...
 late List<String> roles;
          ...
          child: Padding(
            ...
            child: Column(children: [
              ...
              RoundedButton(lable: S.of(context).save, icon: '', color: AppThemeDataService.AccentColor, style: AppTextStyle.largeWhiteBold, go: (){
                  ...
                  EmployeeRequestRole re =
                  EmployeeRequestRole(
                    roles: roles,id: widget.model.id
                     );
                  widget.onSave(re);
  ...
  void initState() {
    super.initState();
    String job = checkRole()??'';
    optionItemSelectedProvidedBy =  Entry(job, 0, []);
