...
class AddContainerSpecificationInit extends StatefulWidget {
  ...
  const AddContainerSpecificationInit({ required this.onSave});

  @override
  _AddCountryInitState createState() => _AddCountryInitState();
}

class _AddCountryInitState extends State<AddContainerSpecificationInit> {
 late TextEditingController name ;
 late  TextEditingController capacityCPM;
 late  TextEditingController widthInMeter;
 late  TextEditingController hightInMeter;
 late  TextEditingController lengthInMeter;
            ...
            child: Column(children: [
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: TextField(
                    controller: capacityCPM,
                    keyboardType: TextInputType.phone,
                    decoration: InputDecoration(
                      border: InputBorder.none,
                      hintText: 'capacityCPM',
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: TextField(
                    controller: lengthInMeter,
                    decoration: InputDecoration(
                      border: InputBorder.none,
                      hintText: 'lengthInMeter',
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: TextField(
                    controller: widthInMeter,
                    decoration: InputDecoration(
                      border: InputBorder.none,
                      hintText: 'widthInMeter',
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: TextField(
                    controller: hightInMeter,
                    decoration: InputDecoration(
                      border: InputBorder.none,
                      hintText: 'hightInMeter',
  ...
  void initState() {
    ...
    capacityCPM = TextEditingController();
    lengthInMeter = TextEditingController();
    widthInMeter = TextEditingController();
    hightInMeter = TextEditingController();
  }
