...
class S {
  ...
  /// `Welcome to pasco_shipping`
  String get welcomeTopasco_shipping {
    return Intl.message(
      'Welcome to pasco_shipping',
      name: 'welcomeTopasco_shipping',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Please Download pasco_shipping`
  String get pleaseDownloadpasco_shipping {
    return Intl.message(
      'Please Download pasco_shipping',
      name: 'pleaseDownloadpasco_shipping',
      desc: '',
      args: [],
    );
  }
